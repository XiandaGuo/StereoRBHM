...
from stereo.modeling.models.coex.coexrbhm import CoExHeight
...
model = LazyCall(CoExHeight)(
    rbhm_pretrained=os.path.join(project_root_dir, 'output/SpeedBumpDataset/RBHM/rbhm_v4/ckpt/epoch_34/pytorch_model.bin')
)
